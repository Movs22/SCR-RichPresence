...
public class RoleSelection extends Activity {
	public static Element ROLE;
	public static Element SERVER_TYPE;
	
	@Override
	public void init() {
		ROLE = new Element("ROLEPICKING.Passenger", 25, -22, 200, 52, Anchor.Horizontal.LEFT, Anchor.Vertical.BOTTOM);
	...
	public Boolean checkStatus(BufferedImage img) {
		return ROLE.doOCR(img).contains("Back");
